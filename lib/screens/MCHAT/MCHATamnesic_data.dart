...
class MCHATAmnesicDataScreen extends StatefulWidget {
  @override
  _MCHATAmnesicDataScreenState createState() => _MCHATAmnesicDataScreenState();
}

class _MCHATAmnesicDataScreenState extends State<MCHATAmnesicDataScreen> {
