...
import '../../widgets/haizea_questionnaire.dart';

class HAIZEALLEVANT_QuestionnaireScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    final questionnaireWidget = const HaizeaQuestionnaireWidget();
